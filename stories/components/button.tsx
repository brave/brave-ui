    ...
    return (
      <div>
        ...
        <ComponentTypes>
          ...
          <Button level='primary' type='danger' text='Danger' />
        ...
        <ComponentTypes>
          ...
          <Button level='secondary' type='danger' text='Danger' />
        ...
        <ComponentTypes>
          ...
          <Button level='tertiary' type='danger' text='Danger' />
        ...
        <ComponentTypes>
          ...
          <Button size='large' level='primary' type='danger' text='Large' />
        </ComponentTypes>
        ...
        <ComponentTypes>
          ...
          <Button size='large' level='secondary' type='danger' text='Large' />
        </ComponentTypes>
        ...
        <ComponentTypes>
          ...
          <Button size='large' level='tertiary' type='danger' text='Large' />
        </ComponentTypes>
        ...
        <ComponentTypes>
          ...
          <Button icon={{ ...icon, position: 'before' }} size='large' level='primary' type='danger' text='Large' />
        </ComponentTypes>
        <ComponentTypes>
          ...
          <Button icon={{ ...icon, position: 'after' }} size='large' level='secondary' type='danger' text='Large' />
        </ComponentTypes>
      </div>
    )
  })
