  ...
  .add('Panel', () => {
    return (
      <div style={{ width: '373px', background: '#fff' }}>
        <WalletPanel
          id={'wallet-panel'}
          platform={select<any>('Provider', { youtube: 'youtube', twitter: 'twitter', twitch: 'twitch', reddit: 'reddit', vimeo: 'vimeo', github: 'github', unsplash: 'unsplash', medium: 'medium', soundcloud: 'soundcloud', stackoverflow: 'stackoverflow' }, 'youtube')}
