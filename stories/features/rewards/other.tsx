    ...
    return (
      <div style={{ width: '400px' }}>
        <Profile
          ...
          provider={select<any>('Provider', { youtube: 'youtube', twitter: 'twitter', twitch: 'twitch', reddit: 'reddit', vimeo: 'vimeo', github: 'github', unsplash: 'unsplash', medium: 'medium', stackoverflow: 'stackoverflow' }, 'youtube')}
          src={favicon}
        />
      </div>
    )
