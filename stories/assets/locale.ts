...
const locale: Record<string, string> = {
  ...
  walletReconnect: 'Connect to a different wallet',
  ...
  walletVerificationListShort1: 'Keep your Ad Rewards tokens',
  walletVerificationListShort2: 'Add tokens using credit card',
  walletVerificationListShort3: 'Withdraw tokens',
