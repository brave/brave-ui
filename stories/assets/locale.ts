...
const locale: Record<string, string> = {
  about: 'about',
  accept: 'Accept',
  activityCopy: '©2016 –2019 Brave Software. Brave is a registered trademark of Brave Software. Site names may be trademarks or registered trademarks of the site owner.',
  ...
  contributeTx: 'Auto-Contribution',
  ...
  donationAllocation: 'Monthly contributions',
  ...
  earningFromAdsTx: 'Earnings from Ads',
  ...
  monthOct: 'October',
  monthSep: 'September',
  monthlyContributions: 'Monthly Contribution',
  monthlyText: 'Monthly',
  ...
  noStatementTransactions: 'No transactions for this period',
  noStatementMonthlyContributions: 'No monthly contributions for this period',
  noStatementAutoContributions: 'No Auto-Contributions for this period',
  noStatementTips: 'No tips for this period',
  ...
  paymentWarning: 'When your remaining balance can not cover the combined total of Auto-Contribute and monthly contributions, they will be skipped for this period.',
  ...
  recurringDonationTx: 'Monthly Tips',
  ...
  rewardsTipDate: 'Date',
  rewardsTipVisited: 'Content Creator',
  settings: 'Settings',
  showAll: 'Show All',
  site: 'site',
  ...
  tipAllocation: 'One-time tips',
  tipOnLike: 'Tip on like',
  tipOnLikeTx: 'Tip on like',
  tips: 'One-Time Tips',
