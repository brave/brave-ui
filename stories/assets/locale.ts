...
const locale: Record<string, string> = {
  ...
  walletVerificationList1: 'Withdraw BAT that you earn from viewing privacy-respected ads',
  walletVerificationList2: 'Purchase additional BAT with your credit card and other sources through Uphold',
  walletVerificationList3: 'Withdraw BAT that you may have previously added to your anonymous Brave wallet',
  walletVerificationListHeader: 'Benefits of Verifying',
  walletVerificationNote: 'Uphold may require you to verify your identity based on services requested. Brave Software can not see your personal info that you share with Uphold.',
  walletVerificationTitle1: 'Verifying your wallet is optional.',
  walletVerificationTitle2: 'No verification necessary to earn rewards and tip creators',
