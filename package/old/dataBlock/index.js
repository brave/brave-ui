...
class DataItem extends React.PureComponent {
    render() {
        ...
        return (React.createElement(style_1.StyledDataItem, { id: id, theme: theme, onClick: onClick, size: size },
            ...
            text
                ? React.createElement(style_1.StyledDataItemText, { theme: theme, size: size }, text)
                : null,
            description
                ? React.createElement(style_1.StyledDataItemDescription, { theme: theme, size: size }, description)
                : null));
    }
}
