            ...
            React.createElement(style_1.StyledHeader, { bg: panel },
                ...
                React.createElement(style_1.StyledBalance, null,
                    ...
                    React.createElement(style_1.StyledBalanceConverted, null,
                        "~ ",
                        converted),
                    React.createElement(buttonSecondary_1.default, { text: helpers_1.getLocale('detail'), size: 'small', color: 'subtle', onClick: enabled ? this.toggleGrantDetails : undefined, disabled: !enabled, icon: { position: 'right', image: this.state.grantDetails && enabled ? arrowUpIcon : arrowDownIcon } })),
