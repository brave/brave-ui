...
const index_2 = require("../../../components/formControls/toggle/index");
...
class Tip extends React.PureComponent {
    ...
    render() {
        ...
        return (React.createElement(style_1.StyledWrapper, { id: id },
            ...
            React.createElement(index_1.default, { title: title || '', actionText: helpers_1.getLocale('sendTip'), balance: balance, donationAmounts: donationAmounts, onAmountSelection: this.onAmountChange, onDonate: this.onDonate, donateType: 'small', theme: {
                    sendBgColor: '#392dd1',
                ...
                React.createElement(style_1.StyledAllow, null,
                    ...
                    React.createElement(style_1.StyledAllowToggle, null,
                        React.createElement(index_2.default, { onToggle: this.onToggle, checked: allow, theme: { onColor: '#fb542b', offColor: '#fb542b' }, size: 'small' }))))));
    }
}
exports.default = Tip;
