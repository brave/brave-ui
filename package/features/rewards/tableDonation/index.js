...
class TableDonation extends React.PureComponent {
        ...
        return rows.map((row) => {
            return {
                content: [
                    ...
                    {
                        content: (React.createElement(index_3.default, { value: row.contribute.tokens, converted: row.contribute.converted, theme: {
                                display: 'block',
    ...
    render() {
        ...
        return (React.createElement(style_1.StyledWrapper, { id: id },
            React.createElement(index_1.default, { children: children, rows: this.getRows(rows), header: this.headers }),
            !allItems && numItems > 0
                ? React.createElement(style_1.StyledToggle, { onClick: onClick }, helpers_1.getLocale('seeAllItems', { numItems }))
                : null));
    }
}
exports.default = TableDonation;
