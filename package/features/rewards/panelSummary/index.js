...
const index_2 = require("../listToken/index");
    ...
    render() {
        ...
        return (React.createElement(style_1.StyledWrapper, { id: id },
            ...
            React.createElement(style_1.StyledTokensWrapper, null,
                React.createElement(index_2.default, { value: grant.tokens, converted: grant.converted, theme: { color: grant.color }, title: helpers_1.getLocale('tokenGrant') }),
                React.createElement(index_2.default, { value: ads.tokens, converted: ads.converted, theme: { color: ads.color }, title: helpers_1.getLocale('earningsAds') }),
                React.createElement(index_2.default, { value: contribute.tokens, converted: contribute.converted, theme: { color: contribute.color }, title: helpers_1.getLocale('rewardsContribute'), isNegative: true }),
                React.createElement(index_2.default, { value: donation.tokens, converted: donation.converted, theme: { color: donation.color }, title: helpers_1.getLocale('recurringDonations'), isNegative: true }),
                React.createElement(index_2.default, { value: tips.tokens, converted: tips.converted, theme: { color: tips.color, borderBottom: 'none' }, title: helpers_1.getLocale('oneTimeDonation'), isNegative: true })),
            ...
            grants && grants.map((grant, i) => {
                return React.createElement(style_1.StyledGrant, { key: `${id}-grant-${i}` },
                    React.createElement(style_1.StyledGrantText, null,
                        React.createElement(index_1.default, { value: grant.tokens, converted: grant.converted, theme: {
                                color: {
