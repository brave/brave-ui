...
const index_1 = require("../amount/index");
        ...
        return (React.createElement(style_1.StyledWrapper, null,
            React.createElement(style_1.StyledContent, { id: id, theme: theme },
                ...
                donationAmounts && donationAmounts.map((donation) => {
                    return React.createElement(index_1.default, { key: `${id}-donate-${donation.tokens}`, amount: donation.tokens, selected: donation.selected, onSelect: this.onAmountChange, converted: donation.converted, type: donateType });
                }),
                children),
