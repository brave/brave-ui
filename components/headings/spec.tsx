...
describe('all heading tests', () => {
  ...
  describe('heading tests', () => {
    ...
    it('can have a custom color', () => {
      const wrapper = shallow(baseHeadingComponent({color: 'red'}))
      const assertion = wrapper.props().color
      expect(assertion).toEqual('red')
    })

    it('can have a custom weight', () => {
      const wrapper = shallow(baseHeadingComponent({weight: 'bold'}))
