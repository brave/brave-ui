...
// This function generates the color palette scales from 000-900
// systemically through a base color. It works with any source color
// but provides the best result when the source color
// falls naturally around 600.
